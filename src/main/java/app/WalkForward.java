...
public class WalkForward {
    ...
    public static void startWalkForward(String bookkeeperOutputPath, String syncopeOutputPath) {
        String bookkeeperFilePath = "./BOOKKEEPER.csv";
        new File(bookkeeperOutputPath).mkdir();
        walkForward(bookkeeperOutputPath, bookkeeperFilePath);

        String syncopeFilePath = "./SYNCOPEb.csv";
        new File(syncopeOutputPath).mkdir();
        walkForward(syncopeOutputPath, syncopeFilePath);
    }
}